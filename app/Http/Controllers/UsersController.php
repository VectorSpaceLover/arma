...
class UsersController extends Controller
{
    ...
    public function update(Request $request, user $user)
    {
        ...
        $user->save();
        if ($user->save()) {
            return redirect('/users')->with(['mensagem' => 'Actualizado com sucesso']);
        } else {
            return redirect('/users')->with(['mensagem' => 'Falha ao Actualizar']);
        }
    }
    ...
    public function destroy(user $user)
    {
        //
        $user->delete();
        return redirect('/users')->with(['mensagem' => 'Excluído com sucesso.']);
    }
}
