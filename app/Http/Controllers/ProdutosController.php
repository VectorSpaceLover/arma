...
class ProdutosController extends Controller {
    ...
    public function create() {
        ...
        return view('produtos.add', compact('categoria'));
    }
    ...
    public function store(Request $request) {
        ...
        if ($produto->save()) {
            return redirect('/produtos')->with(['mensagem' => 'Adicionado com sucesso']);
        } else {
            return redirect('/produtos')->with(['mensagem' => 'Falha ao adicionar']);
        }
    }
...
//
    ...
    public function update(Request $request, Produtos $produto) {
        ...
        $produto->save();
        if ($produto->save()) {
            return redirect('/produtos')->with(['mensagem' => 'Actualizado com sucesso']);
        } else {
            return redirect('/produtos')->with(['mensagem' => 'Falha ao Actualizar']);
        }
    }
    ...
    public function destroy(Produtos $produto) {
        ...
        $produto->save();
        if ($produto->save()) {
            return redirect('/produtos')->with(['mensagem' => 'Deletado com sucesso']);
        } else {
            return redirect('/produtos')->with(['mensagem' => 'Falha ao Deletar']);
        }
    }
