...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 titulo">Categoria</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
...
<div class="text-right" style="margin:10px 20px 0px 20px;">
            <a href="/categorias/create" class="btn btn-primary col-sm-5 col-md-2" style="font-size: 12pt;">
...
<th></th>
                  ...
                  <tbody>
                    ...
                    <tr>
                        <td>{{$categoriaLinha->nome}}</td>
                        <td>{{$categoriaLinha->obs}}</td>
                      
                         <td class="text-center">
                            <a href="categorias/{{$categoriaLinha->id}}/edit " >
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title text-danger" style="font-family:sans-serif;"  id="exampleModalLabel">Deseja deletar o categoria {{$categoriaLinha->nome}}?</h5>
